export const DEFAULT_IMAGES = {
    AVATARS: {
        ...
        PLACEHOLDER: (name: string, background = '9D7FD9', color = 'fff') =>
        ...
        ANONYMOUS: 'https://ui-avatars.com/api/?name=User&background=9D7FD9&color=fff&size=200',

        // Gender-specific defaults
        MALE: 'https://ui-avatars.com/api/?name=M&background=4DB8FF&color=fff&size=200',
        FEMALE: 'https://ui-avatars.com/api/?name=F&background=F178C1&color=fff&size=200',
    },
